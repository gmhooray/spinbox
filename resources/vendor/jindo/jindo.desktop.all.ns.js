...
 * NAVER_Library:Jindo-2.8.2;JavaScript Framework;
...
if (!Function.prototype.bind) {
    Function.prototype.bind = function (target) {
        ...
        nop = function () {},
        wrap = function () {
            return bind.apply(this instanceof nop && target
            ? this
            : target,
...
jindo.$Jindo.checkVarType._throwException = function(aArgs, oRules, sFuncName) {
    ...
    if (/(\$\w+)#(\w+)?/.test(sFuncName)) {
        sURL = 'http://jindo.nhncorp.com/docs/jindo/archive/Jindo2-2.8.2/desktop/ko/classes/' + encodeURIComponent(RegExp.$1) + '.html' + "#method_"+RegExp.$2;
    }
...
jindo.$Element.prototype.offset_get = function(nTop,nLeft){
    ...
    if(bIE){
        if(document.documentMode){
            ...
            nVer = jindo.$Agent().navigator().verison;
        }
    }
